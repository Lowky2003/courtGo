<div class="space-y-8 p-6 max-w-5xl mx-auto w-full">
    ...
    <div class="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-5">
        <flux:input wire:model.live.debounce.300ms="name" label="Place name" placeholder="e.g. Sunway Hall" autocomplete="off" />
        ...
        <flux:input wire:model.live.debounce.300ms="city" label="City" placeholder="e.g. Subang Jaya" autocomplete="off" />
